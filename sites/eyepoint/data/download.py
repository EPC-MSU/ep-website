...
categories = (
    ...
    SoftwareCategory(
        ...
        description=_(
            ...
            " для Visual Studio 2013. Всё это можно скачать на данной странице. <br />"
            "Версии для Windows имеют суффикс win32 или win64 (32 битная или более современная 64 версии). "
    ...
    SoftwareCategory(
        ...
        description=_(
            ...
            "Для работы ПО нужно будет подключить EyePoint S* по USB к компьютеру, поставить драйвер, а также "
            "распространяемые пакеты Microsoft Visual C++ для Visual Studio 2013. Всё это можно скачать на данной странице."
        ),
    ),
    SoftwareCategory(
        name="debugger",
        ...
        description=_(
            ...
            "которые пишут свои программы управления для модулей и устройств EyePoint. Оно позволяет вручную вызывать команды управления, " "задавать их параметры и получать информацию от контроллера. Формирование и разбор полей сложных команд осуществляется "
    ...
    SoftwareCategory(
        ...
        description=_(
            "Комплект примеров программного кода на языках C, C# и Python для устройств линейки EyePoint. "
