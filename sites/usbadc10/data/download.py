...
categories = (
    ...
    SoftwareCategory(
        ...
        description=_(
            ...
            "виде исходных кодов. Также доступна <a href='https://pypi.org/project/usbadc10/'>установка Python-обёртки через PyPI</a> "
            "командой: <code>pip install usbadc10</code> <br>"
