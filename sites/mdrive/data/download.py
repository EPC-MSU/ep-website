...
categories = (
    ...
    SoftwareCategory(
        ...
        description=_(
            ...
            "<h5>Ищите версию для arm64?</h5>"
            "Официально архитектура arm64 пока не поддерживается. Но мы уже работаем над её поддержкой. "
            "Для архитектуры arm64 доступна рабочая сборка (только для Linux). Архив <em>libximc-2.14.17-arm64.zip</em> можно найти на этой странице."
        ),
    ),
    SoftwareCategory(
        name="mdrive",
