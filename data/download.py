...
categories = (
    ...
    SoftwareCategory(
        ...
        icon="software.png",
        description=_(
            "Пользовательское программное обеспечение, аналогичное графическому интерфейсу на устройстве EyePoint S2, для поиска неисправностей на печатных платах с использованием аналоговых сигнатурных "
            "анализаторов EyePoint. Для работы ПО требуется Python 3.6.8 (win32) "
            "с набором необходимых библиотек, драйвер, а также распространяемые "
            "пакеты Microsoft Visual C++ для Visual Studio 2013 (win32). Всё это "
            "можно скачать на данной странице."
    ...
    SoftwareCategory(
        ...
        description=_(
            ...
            "Репозиторий <a href='https://github.com/EPC-MSU/epcboot-gui'>EPCBootGUI на GitHub.</a> " 
        ),
    ),
    SoftwareCategory(
        name="image",
        ...
        icon="software.png",
        description=_(
            "Образы встроенной операционной системы для устройств серии EyePointS. "
