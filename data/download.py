...
categories = (SoftwareCategory(name="documentation", friendly_name=_("Документация"), icon="doc.png",
              ...
              SoftwareCategory(name="software", friendly_name=_("Программное обеспечение"), icon="software.png",
                               description=_("Программное обеспечение для поиска неисправностей на печатных "
                                             ...
                                             "библиотек, драйвер, а также Распространяемые пакеты Microsoft Visual "
                                             "C++ для Visual Studio 2013 (win32). Всё это можно скачать на данной "
                                             "странице.")),
              SoftwareCategory(name="debugger", friendly_name=_("IVM debugger"), icon="software.png",
                               description=_("Кроссплатформенное ПО с графическим интерфейсом для отладки "
              ...
              SoftwareCategory(name="image", friendly_name=_("Прошивка встроенного компьютера"), icon="software.png",
                               description=_("Образы встроенной операционной системы для устройств серии EyePoint S. "
                                             ...
                                             "страницы).")),
              SoftwareCategory(name="library_doc", friendly_name=_("Описание библиотеки для программного управления"),
                               icon="software.png",
                               description=_("Документация к библиотеке libivm, которая может быть использована для "
              ...
              SoftwareCategory(name="library", friendly_name=_("Библиотека для программного управления"),
                               ...
                               description=_("Кроссплатформенная библиотека для работы с измерителями ВАХ EyePoint "
                                             ...
                                             "на этой странице.")),
              SoftwareCategory(name="examples_and_bindings", friendly_name=_("Примеры использования API и биндинги "
                                                                             "для Python и C#"),
                               icon="software.png",
                               description=_("Комплект примеров программного кода на языках C, C# и Python, "
