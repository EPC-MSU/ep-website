...
products = (
    ...
    Product(
        ...
        description=[
            ...
            "каналов в заданной оператором последовательности. <br />"
            "При помощи EP MUX можно производить быстрое тестирование краевых разъемов неисправных плат, "
            "а также проводить входной контроль микросхем при использовании "
            "специализированной оснастки для их установки. "),
        ],
        extended_description=[
            _("Материнская плата мультиплексора, необходимая для работы с модулями Eyepoint MUX S A. "
            "Позволяет подключать до 8 модулей на 64 канала. "),
            _("Модуль мультиплексора на 64 канала. Позволяет зондировать каждый из 64 каналов по "
            "отношению к общему проводу (один к многим). "),
        ],
        hilights=[
