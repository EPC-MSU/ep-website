...
products = (
    Product(
        ...
        extended_description=[
            _("Автоматическая система локализации неисправных электронных компонентов на печатных платах. <br />"
        ...
        technical=[
            ...
            _("Управляющий ПК: Intel core i5 с частотой не ниже 2.8 ГГц, 16 Гб RAM, SSD не менее 240 Гб"),
    ...
    Product(
        ...
        description=[
            _("Автоматическая система для обнаружения контрафактных, перемаркированных или неисправных электронных компонентов в BGA корпусах. "),
        ],
        extended_description=[
            _("Автоматическая система для обнаружения контрафактных, перемаркированных или неисправных электронных компонентов в BGA корпусах. <br />"
            "EyePoint B10 - настольная автоматическая система для обнаружения контрафактных, перемаркированных или неисправных электронных компонентов в BGA корпусах. "
            "EyePoint B10 сравнивает сигнатуры (уникальные вольт-амперные характеристики) каждого вывода исследуемой микросхемы "
            "с сохраненными в памяти опорными данными оригинального чипа и делает вывод не только об исправности исследуемого чипа, "
            "но и о его принадлежности к одной серии или ревизии с оригинальной микросхемой. Система EyePoint B10 использует летающий щуп "
            "и способна работать c BGA-корпусами, с любым существующим на сегодня расположением и шагом выводов без применения специальной оснастки "
        ...
        technical=[
            ...
            _("Рабочие напряжения: 1...12 В"),
            _("Максимальный размер рабочей области: 280x275 мм"),
            _("Поддерживаемые типы корпусов: BGA, LGA, PGA, LCC, CSP и т.д"),
            _("Построение карты тестирования до 10 см²/мин"),
    ...
    Product(
        ...
        description=[
            _("Автоматическая система локализации неисправных электронных компонентов на печатных платах с опцией тестирования чипов BGA "),
        ],
        extended_description=[
            _("Автоматическая система локализации неисправных электронных компонентов на печатных платах с опцией тестирования чипов BGA. <br />"
            "EyePoint P10b - автоматическая настольная система для поиска неисправных электронных компонентов на печатных платах с опцией выявления " "контрафактных, перемаркерованных или поврежденных компонентов в BGA корпусах. "
            ...
            "PCB и BGA, экономия времени на поиске до 3 раз, автоматическая проверка до 2500 выводов "),
        ],
        hilights=[
            _("PCB и BGA"),
    ...
    Product(
        ...
        description=[
            _("Настольный локализатор неисправных электронных компонентов на печатных платах методом аналогового сигнатурного анализа с частотой тестирующего сигнала до 100 кГц. и со встроенным дисплеем. "),
        ],
        extended_description=[
            _("Настольный локализатор неисправных электронных компонентов на печатных платах методом аналогового сигнатурного анализа с частотой тестирующего сигнала до 100 кГц. и со встроенным дисплеем. <br />"
            ...
            "на печатных платах. Система обладает большим удобным сенсорным экраном. Дополнительная педаль позволяет упростить "
            "управление системой. Простой и легкий прибор, частота зондирования до 100 кГц. У прибора имеется режим "
            "план тестирования, который позволяет заранее сохранить эталонную плату в базе и далее работать с такой же "
            "неисправной платой не имея эталона под рукой."),
        ],
        hilights=[
    ...
    Product(
        ...
        extended_description=[
            _("EyePoint u21 – миниатюрный одноканальный локализатор неисправных электронных компонентов на печатных платах методом ASA с частотой тестирующего сигнала до 100 кГц <br />"
    ...
    Product(
        ...
        extended_description=[
            _("EyePoint u22 – миниатюрный двухканальный локализатор неисправных электронных компонентов на печатных платах методом ASA с частотой тестирующего сигнала до 100 кГц <br />"
    ...
    Product(
        ...
        description=[
            _("Одноканальный OEM модуль (без корпуса) аналогового сигнатурного анализа."),
        ],
        extended_description=[
            _("Одноканальный OEM модуль (без корпуса) аналогового сигнатурного анализа. <br />"
    ...
    Product(
        ...
        description=[
            _("Локализатор неисправностей на печатных платах методом сигнатурного анализа "
        ...
        extended_description=[
            _("Локализатор неисправностей на печатных платах методом сигнатурного анализа "
            "с частотой тестирующего сигнала до 12 МГц "
            "и широким диапазоном выбора напряжения и чувствительности по току. <br />"
    ...
    Product(
        ...
        description=[
            _("Материнская плата мультиплексора, необходимая для работы с модулями <b>Eyepoint MUX_S_A</b>. "
        ...
        extended_description=[
            ...
            "Позволяет подключать до 8 модулей на 64 канала каждый (в сумме до 512 каналов). "
            "Используется совместно с сигнатурными анализаторами линейки EyePoint. "),
            _("EyePoint MUX предназначен для коммутирования одного входного канала на "
    ...
    Product(
        ...
        description=[
            _("Модуль мультиплексора на 64 канала. "
