...
products = (
    ...
    Product(
        ...
        description=[
            ...
            "Позволяет подключать до 8 модулей на 64 канала. "),
        ],
        extended_description=[
            _("Материнская плата мультиплексора, необходимая для работы с модулями <b>Eyepoint MUX_S_A</b>. "
            "Позволяет подключать до 8 модулей на 64 канала. "),
    ...
    Product(
        ...
        description=[
            _("Модуль мультиплексора на 64 канала. Позволяет зондировать каждый из 64 каналов "
            "по отношению к общему проводу (один к многим). "),
        ],
        extended_description=[
            _("Модуль мультиплексора на 64 канала работающий в комплекте с материнской платой мультиплексора <b>EyePoint MUX_M</b>. "
