...
products = (
    Product(
        ...
        extended_description=_("Аналого-цифровой преобразователь USBADC10 имеет частоту до 4000 отсчётов в секунду, " 
                                "одновременно по всем каналам. В комплекте с устройством поставляется программное "
                                "обеспечение для получения измерений. ПО поддерживается ОС Windows и Linux. Все необходимое " "<b>программное обеспечение</b> можно найти в свободном доступе. "),
