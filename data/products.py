...
products = (
    ...
    Product(
        name="EyePoint_MUX_M",
        friendly_name=_("EyePoint MUX M"),
        picture=[
            _("mux_m.png"),
        ],
        description=[
            _("Материнская плата мультиплексора, необходимая для работы с модулями <b>Eyepoint MUX S A</b>. "
    ...
    Product(
        ...
        friendly_name=_("EyePoint MUX S A"),
        picture=[
            _("mux_sa.png"),
        ],
        description=[
