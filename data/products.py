...
products = (
    ...
    Product(
        ...
        extended_description=[
            _(
                ...
                "компонентов в BGA корпусах. Система сочетает в себе автоматическую оптическую систему распознавания "
                "выводов компонентов и летающий щуп для проведения электрического тестирования методом аналогового "
                "сигнатурного анализа. PCB и BGA, экономия времени на поиске до 3 раз, автоматическая проверка до "
                "2500 выводов "
            ),
        ],
        hilights=[
    ...
    Product(
        ...
        description=[
            _(
                "EyePoint u21 – миниатюрный одноканальный локализатор неисправных электронных компонентов на "
                "печатных платах методом ASA с частотой тестирующего сигнала до 100 кГц"
            ),
        ],
        extended_description=[
            _(
                "EyePoint u21 – миниатюрный одноканальный локализатор неисправных электронных компонентов на "
                "печатных платах методом ASA с частотой тестирующего сигнала до 100 кГц <br />"
                "EyePoint u21 – простой, компактный настольный прибор, с возможностью программного управления, "
                "младший в линейке EyePoint, поставляемый в виде моноблока и включающий корпус, плату управления "
                "и комплектующийся измерительным щупом и зажимом «Крокодил», кабелем USB для подключения к ПК."
            ),
        ],
        hilights=[
            _("Частота зондирования до 100 кГц"),
    ...
    Product(
        ...
        description=[
            _(
                "EyePoint u22 – миниатюрный двухканальный локализатор неисправных электронных компонентов на "
                "печатных платах методом ASA с частотой тестирующего сигнала до 100 кГц"
            ),
        ],
        extended_description=[
            _(
                "EyePoint u22 – миниатюрный двухканальный локализатор неисправных электронных компонентов на "
                "печатных платах методом ASA с частотой тестирующего сигнала до 100 кГц <br />"
                "Миниатюрная версия двухканального ручного локализатора неисправных электронных компонентов с "
                "прямым подключением к " "ПК, частотой до 100 кГц EyePoint u22 – простой, компактный настольный "
                "прибор, с возможностью программного управления, младший в линейке EyePoint, поставляемый в виде "
                "моноблока и включающий корпус, плату управления и комплектующийся измерительными щупами и зажимами "
                "«Крокодил», кабелем USB для подключения к ПК."
            ),
        ],
        hilights=[
            _("Частота зондирования до 100 кГц"),
    ...
    Product(
        ...
        technical=[
            _("Метод тестирования: АСА"),
            _(
                "Диапазон частот тестирующего сигнала: 1, 5, 10, 50, 100, 400 Гц. "
