...
products = (
    ...
    Product(
        ...
        description=_(
            ...
            "методом сигнатурного анализа с частотой тестирующего сигнала до 12 МГц "
            "и широким диапазоном выбора напряжения и чувствительности по току."
        ),
        extended_description=_(
            "Аналоговый сигнатурный анализатор для поиска неисправных электронных компонентов на печатных "
            "платах с частотой пробного сигнала до 12 МГц, что позволяет искать неисправности на высокочастотных платах. "
