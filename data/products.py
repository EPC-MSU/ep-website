...
products = (
    Product(
        ...
        description=[
            _("Автоматическая настольная система для поиска неисправных электронных компонентов на "
            "печатных платах методом АСА."),
        ],
        extended_description=[
            _("Автоматическая настольная система для поиска неисправных электронных компонентов на "
            "печатных платах методом АСА. <br />"
    ...
    Product(
        ...
        extended_description=[
            ...
            "но и о его принадлежности к одной серии или ревизии с оригинальной микросхемой. C EyePoint B10 вы быстро получите результат! "
            "Например, все выводы компонента в корпусе BGA484 будут проверены за 5 мин. Система EyePoint B10 использует летающий щуп "
            ...
            "или ручной настройки. EyePoint B10 не нужно программировать: расположение всех выводов исследуемого BGA-чипа определит "
            "встроенный полностью автоматический оптический сканер. Cравнение с эталонным чипом произведет встроенное автоматическое "
            "ПО сигнатурного анализа."),
        ],
        hilights=[
            _("Прост в использовании"),
            _("Снизит нагрузку на инженера"),
        ...
        technical=[
            ...
            _("Рабочие напряжения: 1,2, 3,3, 5, 12 В"),
            _("Максимальный размер платы: 280x275 мм"),
            _("Поддержка корпусов: BGA, LGA, PGA, LCC, CSP и т.д"),
            _("Построение карты тестирования до 10 см²/мин"),
            _("Скорость тестирования: до 100 точек в мин"),
            _("Точность установки щупа: 30 мкм"),
            _("Время на смену платы: 10 сек"),
            _("Тестирующее напряжение до +/- 12 В"),
            _("Чувствительность по R 2 Ом - 450 кОм"),
            _("Чувствительность по C 300 пФ - 100 мкФ"),
            _("Чувствительность по L от 270 мкГн"),
            _("Габариты и вес: 604х543х473 мм, 50 кг"),
            _("Управляющий ПК: Intel i5 3 ГГц, 16 Гб RAM, 240 Гб SSD"),
            _("Электропитание: ~220В, 300 Вт"),
        ],
    ),
    Product(
        ...
        description=[
            _("EyePoint P10b - автоматическая настольная система для поиска неисправных электронных "
        ...
        extended_description=[
            _("EyePoint P10b - автоматическая настольная система для поиска неисправных электронных "
            "компонентов на печатных платах с опцией выявления контрафактных, перемаркерованных или "
            "поврежденных компонентов в BGA корпусах. <br />"
            "Система сочетает в себе автоматическую оптическую систему распознавания выводов "
            "компонентов и летающий щуп для проведения электрического тестирования методом "
            "аналогового сигнатурного анализа."),
        ],
