...
Для каждого типа сайта (eyepoint, usbadc10) есть stable и dev ветка. Сайт из dev ветки живёт на тестовом домене. 
Сайт из ветки stable разворачивается в production. Сливать dev в stable можно только после тестирования на dev.
